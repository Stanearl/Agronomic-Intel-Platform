...
/**
 * DashboardToolbar
 * High-contrast light application bar used exclusively inside the
 * data-dense Dashboard view. Carries the official platform name, the
 * Kenya Sugar Board badge, the active dataset indicator, and the
 * global "Reset Filters" action. Flat, dense, zero glow — distinct
 * from the marketing "liquid glass" Header used on the public
 * Landing Page.
 */
export default function DashboardToolbar({ onResetFilters, recordCount, totalCount }) {
  return (
